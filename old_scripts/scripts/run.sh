...
export JSON_DIR="${BASE_DIR}/json/new"
export REPORTS_DIR="${BASE_DIR}/reports"
export TOKEN_USAGE_DIR="${BASE_DIR}/token-usage"
export PROCESSED_DIR="${MD_DIR}/processed"

# ─── 配置文件 ─────────────────────────────────────────────
export PROMPT_PATH="${BASE_DIR}/configs/nutri_gene_prompt_v4.txt"
export SCHEMA_PATH="${BASE_DIR}/configs/nutri_gene_schema_v4.json"
