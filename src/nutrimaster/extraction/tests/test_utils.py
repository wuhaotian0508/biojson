"""
Tests for src/nutrimaster/extraction/utils.py shared utilities.

Run: python -m pytest src/nutrimaster/extraction/tests/test_utils.py -v
"""

from nutrimaster.extraction.utils import ensure_list, get_gene_name, safe_parse_json, stem_to_dirname
